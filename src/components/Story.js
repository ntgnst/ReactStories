      ...
      <div style={{ ...styles.story, width: this.props.width, height: this.props.height }}>
        ...
        {this.props.story.seeMore &&
          <div style={{ position: 'absolute', margin: 'auto', bottom: 0, zIndex: 9999, width: '100%' }}>
            <SeeMore action={this.props.action} toggleMore={this.toggleMore} showContent={this.state.showMore} seeMoreText={this.props.story.seeMoreText} seeMoreContent={this.props.story.seeMore} />
          </div>}
      </div>
    )
  }
